...
function ExerciseeOne() {
    ...
    const fetchData = async () => {
      try {
        ...
        const filteredData = responseData.data.filter(
          (problem) =>
            (problem.difficulty === "Easy" && problem.category === "Stack") ||
            (problem.category === "LinkedList" &&
              problem.difficulty === "Easy") ||
            (problem.category === "Greedy" && problem.difficulty === "Easy")
        );
  ...
  return (
    <div>
      ...
      <div>
        <Backgroundgif />
        <h1 className="Text">DATA Strcucture LEVEL 1</h1>
